...
<body>
	<div ng-controller="editExamsSchedulesCtrl" ng-init="init('${evaluationEvent.id}', ${evaluationEvent.scheduleModificationDate});" ng-cloak>
		<table class="table table-borderless">
			<tr>
				<td class="no-padding"><h3 class="no-margin">Modificar horarios de exámenes</h3></td>
				<td class="no-padding text-right"><a href="<c:url value="/student/evaluationevent/${evaluationEvent.id}"/>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Volver</a></td>
			</tr>
		</table>
		<div ng-show="scheduleModificationAttempts.remainingAttempts > 0 && isScheduleModificationDate" id="editExamsSchedulesWizard">
			<div ng-show="lastScheduleModification != null" class="right-buttons" style="margin-bottom: 12px;">
				<button class="btn btn-default" ng-click="showLastScheduleModification()"><span class="glyphicon glyphicon-print"></span> Imprimir última modificación de horarios</button>
			</div>
			...
			<div ng-show="modifiedMatterTests().length > 0">
				...
				<div class="right-buttons" style="margin-top: 12px;">
					<button class="btn btn-default" ng-click="editExamsSchedules()"><span class="glyphicon glyphicon-calendar"></span> Modificar horarios</button>
		...
		<div ng-show="scheduleModificationAttempts.remainingAttempts == 0">
			<h4>Ha agotado el número de intentos permitidos de modificación de horarios</h4>
		</div>
		<div ng-show="!isScheduleModificationDate">
			<h4>Está fuera del plazo establecido para la modificación de horarios de exámenes</h4>
		</div>
	...
	<content tag="local_script">
		<script type="text/javascript" src="<c:url value="/web-resources/js/controller/student/edit-exams-schedules-ctrl.js" />" charset="utf-8"></script>
	</content>
</body>
</html>